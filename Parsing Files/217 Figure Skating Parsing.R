...
all_files <- list.files(path = "Data/217 Figure Skating JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Data/217 Figure Skating JSONs/", json_file_name)
...
key_file <- "Data/217 Figure Skating CSVs/217 Lookup.csv"
