...
all_files <- list.files(path = "Output Folder/221 Freestyle Skiing JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Output Folder/221 Freestyle Skiing JSONs/", json_file_name)
  ...
  # Two lists returned from Participant List for some reason...
  # So I can't use the as.data.frame function, but the do.call works
  ...
  output_file_name <- unique(paste0("Output Folder/221 Freestyle Skiing CSVs/", 
