...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Data/218 Biathlon JSONs/", json_file_name)
  ...
  output_file_name <- unique(paste0("Data/218 Biathlon CSVs/", 
                                    MatchID, ".csv"))
...
key_file <- "Data/218 Biathlon CSVs/218 Lookup.csv"
