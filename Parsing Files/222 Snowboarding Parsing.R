...
all_files <- list.files(path = "Data/222 Snowboarding JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Data/222 Snowboarding JSONs/", json_file_name)
  ...
  output_file_name <- unique(paste0("Data/222 Snowboarding CSVs/", 
                                    MatchID, ".csv"))
...
key_file <- "Data/222 Snowboarding CSVs/222 Lookup.csv"
