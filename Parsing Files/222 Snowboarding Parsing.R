...
all_files <- list.files(path = "Output Folder/222 Snowboarding JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Output Folder/222 Snowboarding JSONs/", json_file_name)
  ...
  # Sports that have a qualifying and finals need the do.call
  ...
  output_file_name <- unique(paste0("Output Folder/222 Snowboarding CSVs/", 
