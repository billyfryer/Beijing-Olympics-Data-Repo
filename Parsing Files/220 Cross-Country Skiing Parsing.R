...
all_files <- list.files(path = "Data/220 Cross-Country Skiing JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Data/220 Cross-Country Skiing JSONs/", json_file_name)
  ...
  output_file_name <- unique(paste0("Data/220 Cross-Country Skiing CSVs/", 
                                    MatchID, ".csv"))
...
key_file <- "Data/220 Cross-Country Skiing CSVs/220 Lookup.csv"
