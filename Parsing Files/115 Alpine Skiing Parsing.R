...
all_files <- list.files(path = "Output Folder/115 Alpine Skiing JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Output Folder/115 Alpine Skiing JSONs/", json_file_name)
  ...
  output_file_name <- unique(paste0("Output Folder/115 Alpine Skiing CSVs/", 
