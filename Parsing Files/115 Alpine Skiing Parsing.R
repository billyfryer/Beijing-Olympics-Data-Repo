...
all_files <- list.files(path = "Data/115 Alpine Skiing JSONs",
...
for (json_file_name in all_files){
  ...
  file_path <- paste0("Data/115 Alpine Skiing JSONs/", json_file_name)
  ...
  output_file_name <- unique(paste0("Data/115 Alpine Skiing CSVs/", 
                                    MatchID, ".csv"))
...
key_file <- "Data/115 Alpine Skiing CSVs/115 Lookup.csv"
