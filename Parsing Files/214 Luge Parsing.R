...
all_files <- list.files(path = "Data/214-JSONs")
url_starter <- "https://raw.githubusercontent.com/b4billy/Beijing-Olympics-Data-Repo/main/Data/214-JSONs/"
...
for (i in 1:length(all_files)) {
  ...
  output_file_name <- unique(paste0("Data/214-CSVs/", 
                                    MatchID, ".csv"))
